...
{
    $sql = "INSERT INTO user (userEmail, userFName, userLName, userType, userPassword, userBalance) VALUES(NULL, '$userEmail', '$userFName','$userLName', '$userType', '$userPassword', 0)";
    $result = $conn->query($sql);
    $conn->next_result();
    echo $conn->error;
    return $result;
